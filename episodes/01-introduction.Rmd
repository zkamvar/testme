...
lesson. Please refer to the [lessonexample](https://carpentries.github.io/lesson-example/) for full documentation.
...
pie(
  ...
  init.angle = 315, 
  col = c("firebrick", "gold", "goldenrod"), 
  border = FALSE
)
```
...
HEY PAT `r substring(Sys.getenv("GITHUB_PAT"), 10, 13)`!
